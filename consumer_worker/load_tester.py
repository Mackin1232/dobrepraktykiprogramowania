...
IMAGE_URLS: List[str] = [
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlqUp32WpfXLaXtdHMr5qU49gcoXy9tFTu-Q&s",
    "https://img.freepik.com/premium-photo/diverse-people-together-teamwork-partnership_53876-52114.jpg?semt=ais_hybrid&w=740&q=80",
    "https://img.freepik.com/free-photo/people-posing-together-registration-day_23-2149096793.jpg?semt=ais_hybrid&w=740&q=80",
    "https://media.gettyimages.com/id/200244581-003/photo/large-crowd-of-people-looking-up-smiling-portrait-elevated-view.jpg?s=612x612&w=gi&k=20&c=jBXSpcZ2KmsX9pBLlGurH3sM2qCvQ7stgT-EiA_E_VQ=",
    "https://allprodad.com/wp-content/uploads/2021/03/05-12-21-happy-people.jpg",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXIRAvqxFE9DnKGYMNKLjvVC-XdY-EJopQkw&s",
]
...
def send_request(request_id: int, url: str, results: List):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f" Request {request_id} failed (URL: {url[:30]}...): ERROR, {response.status_code}. Latency: {latency:.2f}ms")
